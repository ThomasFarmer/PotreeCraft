...
SOURCES = \
	__init__.py \
	potreecraft.py potreecraft_dialog.py potreecraft_util.py

PLUGINNAME = potreecraft

PY_FILES = \
	__init__.py \
	potreecraft.py potreecraft_dialog.py potreecraft_util.py

UI_FILES = potreecraft_dialog_base.ui
...
QGISDIR=C:\Users\tberes\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
