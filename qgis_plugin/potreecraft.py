...
class PotreeCraft:
    ...
    def __init__(self, iface):
        ...
        # Create dialog lazily to ensure current project layers are always loaded.
        self.dlg = None
        ...
        self.toolbar = self.iface.addToolBar(u'PotreeCraft')
        self.toolbar.setObjectName(u'PotreeCraft')
    ...
    def run(self):
        ...
        if self.dlg is None:
            ...
            self.dlg.refresh_vector_layers()
