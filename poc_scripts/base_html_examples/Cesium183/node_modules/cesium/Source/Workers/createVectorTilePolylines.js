...
define(['./Cartesian2-29c15ffd', './AttributeCompression-69f7b4c3', './Math-03750a0b', './IndexDatatype-8e4fb082', './createTaskProcessorWorker', './Check-ed9ffed2', './when-f31b6bd1', './WebGLConstants-0664004c'], function (Cartesian2, AttributeCompression, _Math, IndexDatatype, createTaskProcessorWorker, Check, when, WebGLConstants) { 'use strict';
